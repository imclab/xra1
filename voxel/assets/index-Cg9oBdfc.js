...
`].filter(Os).join(`
`)),o=Rr(o),o=el(o,n),o=nl(o,n),r=Rr(r),r=el(r,n),r=nl(r,n),o=il(o),r=il(r),n.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
}`;function Fm(e,t,n){let i=new Gr;const s=new $t,a=new $t,o=new be,r=new Dm({depthPacking:Au}),c=new Im,l={},h=n.maxTextureSize,u={[ui]:Xe,[Xe]:ui,[Tn]:Tn},f=new Yn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new $t},radius:{value:4}},vertexShader:Um,fragmentShader:Nm}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const _=new $n;_.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new sn(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Fl;let p=this.type;this.render=function(b,E,w){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const S=e.getRenderTarget(),y=e.getActiveCubeFace(),R=e.getActiveMipmapLevel(),I=e.state;I.setBlending(li),I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const L=p!==kn&&this.type===kn,D=p===kn&&this.type!==kn;for(let F=0,O=b.length;F<O;F++){const X=b[F],V=X.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const tt=V.getFrameExtents();if(s.multiply(tt),a.copy(V.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/tt.x),s.x=a.x*tt.x,V.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/tt.y),s.y=a.y*tt.y,V.mapSize.y=a.y)),V.map===null||L===!0||D===!0){const U=this.type!==kn?{minFilter:je,magFilter:je}:{};V.map!==null&&V.map.dispose(),V.map=new Ii(s.x,s.y,U),V.map.texture.name=X.name+".shadowMap",V.camera.updateProjectionMatrix()}e.setRenderTarget(V.map),e.clear();const et=V.getViewportCount();for(let U=0;U<et;U++){const B=V.getViewport(U);o.set(a.x*B.x,a.y*B.y,a.x*B.z,a.y*B.w),I.viewport(o),V.updateMatrices(X,U),i=V.getFrustum(),v(E,w,V.camera,X,this.type)}V.isPointLightShadow!==!0&&this.type===kn&&M(V,w),V.needsUpdate=!1}p=this.type,m.needsUpdate=!1,e.setRenderTarget(S,y,R)};function M(b,E){const w=t.update(g);f.defines.VSM_SAMPLES!==b.blurSamples&&(f.defines.VSM_SAMPLES=b.blurSamples,d.defines.VSM_SAMPLES=b.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new Ii(s.x,s.y)),f.uniforms.shadow_pass.value=b.map.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,e.setRenderTarget(b.mapPass),e.clear(),e.renderBufferDirect(E,null,w,f,g,null),d.uniforms.shadow_pass.value=b.mapPass.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,e.setRenderTarget(b.map),e.clear(),e.renderBufferDirect(E,null,w,d,g,null)}function x(b,E,w,S){let y=null;const R=w.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(R!==void 0)y=R;else if(y=w.isPointLight===!0?c:r,e.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const I=y.uuid,L=E.uuid;let D=l[I];D===void 0&&(D={},l[I]=D);let F=D[L];F===void 0&&(F=y.clone(),D[L]=F,E.addEventListener("dispose",T)),y=F}if(y.visible=E.visible,y.wireframe=E.wireframe,S===kn?y.side=E.shadowSide!==null?E.shadowSide:E.side:y.side=E.shadowSide!==null?E.shadowSide:u[E.side],y.alphaMap=E.alphaMap,y.alphaTest=E.alphaTest,y.map=E.map,y.clipShadows=E.clipShadows,y.clippingPlanes=E.clippingPlanes,y.clipIntersection=E.clipIntersection,y.displacementMap=E.displacementMap,y.displacementScale=E.displacementScale,y.displacementBias=E.displacementBias,y.wireframeLinewidth=E.wireframeLinewidth,y.linewidth=E.linewidth,w.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const I=e.properties.get(y);I.light=w}return y}function v(b,E,w,S,y){if(b.visible===!1)return;if(b.layers.test(E.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&y===kn)&&(!b.frustumCulled||i.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,b.matrixWorld);const L=t.update(b),D=b.material;if(Array.isArray(D)){const F=L.groups;for(let O=0,X=F.length;O<X;O++){const V=F[O],tt=D[V.materialIndex];if(tt&&tt.visible){const et=x(b,tt,S,y);b.onBeforeShadow(e,b,E,w,L,et,V),e.renderBufferDirect(w,null,L,et,b,V),b.onAfterShadow(e,b,E,w,L,et,V)}}}else if(D.visible){const F=x(b,D,S,y);b.onBeforeShadow(e,b,E,w,L,F,null),e.renderBufferDirect(w,null,L,F,b,null),b.onAfterShadow(e,b,E,w,L,F,null)}}const I=b.children;for(let L=0,D=I.length;L<D;L++)v(I[L],E,w,S,y)}function T(b){b.target.removeEventListener("dispose",T);for(const w in l){const S=l[w],y=b.target.uuid;y in S&&(S[y].dispose(),delete S[y])}}}const Om={[Wo]:Xo,[Yo]:Zo,[qo]:jo,[ds]:$o,[Xo]:Wo,[Zo]:Yo,[jo]:qo,[$o]:ds};function zm(e,t){function n(){let H=!1;const mt=new be;let it=null;const ot=new be(0,0,0,0);return{setMask:function(xt){it!==xt&&!H&&(e.colorMask(xt,xt,xt,xt),it=xt)},setLocked:function(xt){H=xt},setClear:function(xt,_t,Xt,Se,Ie){Ie===!0&&(xt*=Se,_t*=Se,Xt*=Se),mt.set(xt,_t,Xt,Se),ot.equals(mt)===!1&&(e.clearColor(xt,_t,Xt,Se),ot.copy(mt))},reset:function(){H=!1,it=null,ot.set(-1,0,0,0)}}}function i(){let H=!1,mt=!1,it=null,ot=null,xt=null;return{setReversed:function(_t){if(mt!==_t){const Xt=t.get("EXT_clip_control");mt?Xt.clipControlEXT(Xt.LOWER_LEFT_EXT,Xt.ZERO_TO_ONE_EXT):Xt.clipControlEXT(Xt.LOWER_LEFT_EXT,Xt.NEGATIVE_ONE_TO_ONE_EXT);const Se=xt;xt=null,this.setClear(Se)}mt=_t},getReversed:function(){return mt},setTest:function(_t){_t?K(e.DEPTH_TEST):Q(e.DEPTH_TEST)},setMask:function(_t){it!==_t&&!H&&(e.depthMask(_t),it=_t)},setFunc:function(_t){if(mt&&(_t=Om[_t]),ot!==_t){switch(_t){case Wo:e.depthFunc(e.NEVER);break;case Xo:e.depthFunc(e.ALWAYS);break;case Yo:e.depthFunc(e.LESS);break;case ds:e.depthFunc(e.LEQUAL);break;case qo:e.depthFunc(e.EQUAL);break;case $o:e.depthFunc(e.GEQUAL);break;case Zo:e.depthFunc(e.GREATER);break;case jo:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}ot=_t}},setLocked:function(_t){H=_t},setClear:function(_t){xt!==_t&&(mt&&(_t=1-_t),e.clearDepth(_t),xt=_t)},reset:function(){H=!1,it=null,ot=null,xt=null,mt=!1}}}function s(){let H=!1,mt=null,it=null,ot=null,xt=null,_t=null,Xt=null,Se=null,Ie=null;return{setTest:function(ce){H||(ce?K(e.STENCIL_TEST):Q(e.STENCIL_TEST))},setMask:function(ce){mt!==ce&&!H&&(e.stencilMask(ce),mt=ce)},setFunc:function(ce,rn,In){(it!==ce||ot!==rn||xt!==In)&&(e.stencilFunc(ce,rn,In),it=ce,ot=rn,xt=In)},setOp:function(ce,rn,In){(_t!==ce||Xt!==rn||Se!==In)&&(e.stencilOp(ce,rn,In),_t=ce,Xt=rn,Se=In)},setLocked:function(ce){H=ce},setClear:function(ce){Ie!==ce&&(e.clearStencil(ce),Ie=ce)},reset:function(){H=!1,mt=null,it=null,ot=null,xt=null,_t=null,Xt=null,Se=null,Ie=null}}}const a=new n,o=new i,r=new s,c=new WeakMap,l=new WeakMap;let h={},u={},f=new WeakMap,d=[],_=null,g=!1,m=null,p=null,M=null,x=null,v=null,T=null,b=null,E=new Qt(0,0,0),w=0,S=!1,y=null,R=null,I=null,L=null,D=null;const F=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,X=0;const V=e.getParameter(e.VERSION);V.indexOf("WebGL")!==-1?(X=parseFloat(/^WebGL (\d)/.exec(V)[1]),O=X>=1):V.indexOf("OpenGL ES")!==-1&&(X=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),O=X>=2);let tt=null,et={};const U=e.getParameter(e.SCISSOR_BOX),B=e.getParameter(e.VIEWPORT),$=new be().fromArray(U),N=new be().fromArray(B);function k(H,mt,it,ot){const xt=new Uint8Array(4),_t=e.createTexture();e.bindTexture(H,_t),e.texParameteri(H,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(H,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let Xt=0;Xt<it;Xt++)H===e.TEXTURE_3D||H===e.TEXTURE_2D_ARRAY?e.texImage3D(mt,0,e.RGBA,1,1,ot,0,e.RGBA,e.UNSIGNED_BYTE,xt):e.texImage2D(mt+Xt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,xt);return _t}const J={};J[e.TEXTURE_2D]=k(e.TEXTURE_2D,e.TEXTURE_2D,1),J[e.TEXTURE_CUBE_MAP]=k(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[e.TEXTURE_2D_ARRAY]=k(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),J[e.TEXTURE_3D]=k(e.TEXTURE_3D,e.TEXTURE_3D,1,1),a.setClear(0,0,0,1),o.setClear(1),r.setClear(0),K(e.DEPTH_TEST),o.setFunc(ds),zt(!1),Ot(uc),K(e.CULL_FACE),z(li);function K(H){h[H]!==!0&&(e.enable(H),h[H]=!0)}function Q(H){h[H]!==!1&&(e.disable(H),h[H]=!1)}function lt(H,mt){return u[H]!==mt?(e.bindFramebuffer(H,mt),u[H]=mt,H===e.DRAW_FRAMEBUFFER&&(u[e.FRAMEBUFFER]=mt),H===e.FRAMEBUFFER&&(u[e.DRAW_FRAMEBUFFER]=mt),!0):!1}function ft(H,mt){let it=d,ot=!1;if(H){it=f.get(mt),it===void 0&&(it=[],f.set(mt,it));const xt=H.textures;if(it.length!==xt.length||it[0]!==e.COLOR_ATTACHMENT0){for(let _t=0,Xt=xt.length;_t<Xt;_t++)it[_t]=e.COLOR_ATTACHMENT0+_t;it.length=xt.length,ot=!0}}else it[0]!==e.BACK&&(it[0]=e.BACK,ot=!0);ot&&e.drawBuffers(it)}function bt(H){return _!==H?(e.useProgram(H),_=H,!0):!1}const St={[Si]:e.FUNC_ADD,[Qh]:e.FUNC_SUBTRACT,[tu]:e.FUNC_REVERSE_SUBTRACT};St[eu]=e.MIN,St[nu]=e.MAX;const Kt={[iu]:e.ZERO,[su]:e.ONE,[au]:e.SRC_COLOR,[Ho]:e.SRC_ALPHA,[uu]:e.SRC_ALPHA_SATURATE,[lu]:e.DST_COLOR,[ru]:e.DST_ALPHA,[ou]:e.ONE_MINUS_SRC_COLOR,[Go]:e.ONE_MINUS_SRC_ALPHA,[hu]:e.ONE_MINUS_DST_COLOR,[cu]:e.ONE_MINUS_DST_ALPHA,[fu]:e.CONSTANT_COLOR,[du]:e.ONE_MINUS_CONSTANT_COLOR,[pu]:e.CONSTANT_ALPHA,[mu]:e.ONE_MINUS_CONSTANT_ALPHA};function z(H,mt,it,ot,xt,_t,Xt,Se,Ie,ce){if(H===li){g===!0&&(Q(e.BLEND),g=!1);return}if(g===!1&&(K(e.BLEND),g=!0),H!==Jh){if(H!==m||ce!==S){if((p!==Si||v!==Si)&&(e.blendEquation(e.FUNC_ADD),p=Si,v=Si),ce)switch(H){case ls:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case fc:e.blendFunc(e.ONE,e.ONE);break;case dc:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case pc:e.blendFuncSeparate(e.ZERO,e.SRC_COLOR,e.ZERO,e.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case ls:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case fc:e.blendFunc(e.SRC_ALPHA,e.ONE);break;case dc:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case pc:e.blendFunc(e.ZERO,e.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}M=null,x=null,T=null,b=null,E.set(0,0,0),w=0,m=H,S=ce}return}xt=xt||mt,_t=_t||it,Xt=Xt||ot,(mt!==p||xt!==v)&&(e.blendEquationSeparate(St[mt],St[xt]),p=mt,v=xt),(it!==M||ot!==x||_t!==T||Xt!==b)&&(e.blendFuncSeparate(Kt[it],Kt[ot],Kt[_t],Kt[Xt]),M=it,x=ot,T=_t,b=Xt),(Se.equals(E)===!1||Ie!==w)&&(e.blendColor(Se.r,Se.g,Se.b,Ie),E.copy(Se),w=Ie),m=H,S=!1}function fe(H,mt){H.side===Tn?Q(e.CULL_FACE):K(e.CULL_FACE);let it=H.side===Xe;mt&&(it=!it),zt(it),H.blending===ls&&H.transparent===!1?z(li):z(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),o.setFunc(H.depthFunc),o.setTest(H.depthTest),o.setMask(H.depthWrite),a.setMask(H.colorWrite);const ot=H.stencilWrite;r.setTest(ot),ot&&(r.setMask(H.stencilWriteMask),r.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),r.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),Jt(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?K(e.SAMPLE_ALPHA_TO_COVERAGE):Q(e.SAMPLE_ALPHA_TO_COVERAGE)}function zt(H){y!==H&&(H?e.frontFace(e.CW):e.frontFace(e.CCW),y=H)}function Ot(H){H!==jh?(K(e.CULL_FACE),H!==R&&(H===uc?e.cullFace(e.BACK):H===Kh?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):Q(e.CULL_FACE),R=H}function Tt(H){H!==I&&(O&&e.lineWidth(H),I=H)}function Jt(H,mt,it){H?(K(e.POLYGON_OFFSET_FILL),(L!==mt||D!==it)&&(e.polygonOffset(mt,it),L=mt,D=it)):Q(e.POLYGON_OFFSET_FILL)}function Ct(H){H?K(e.SCISSOR_TEST):Q(e.SCISSOR_TEST)}function P(H){H===void 0&&(H=e.TEXTURE0+F-1),tt!==H&&(e.activeTexture(H),tt=H)}function A(H,mt,it){it===void 0&&(tt===null?it=e.TEXTURE0+F-1:it=tt);let ot=et[it];ot===void 0&&(ot={type:void 0,texture:void 0},et[it]=ot),(ot.type!==H||ot.texture!==mt)&&(tt!==it&&(e.activeTexture(it),tt=it),e.bindTexture(H,mt||J[H]),ot.type=H,ot.texture=mt)}function q(){const H=et[tt];H!==void 0&&H.type!==void 0&&(e.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function nt(){try{e.compressedTexImage2D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function rt(){try{e.compressedTexImage3D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function at(){try{e.texSubImage2D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Pt(){try{e.texSubImage3D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function pt(){try{e.compressedTexSubImage2D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function yt(){try{e.compressedTexSubImage3D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ee(){try{e.texStorage2D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ht(){try{e.texStorage3D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function wt(){try{e.texImage2D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Nt(){try{e.texImage3D.apply(e,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function kt(H){$.equals(H)===!1&&(e.scissor(H.x,H.y,H.z,H.w),$.copy(H))}function At(H){N.equals(H)===!1&&(e.viewport(H.x,H.y,H.z,H.w),N.copy(H))}function te(H,mt){let it=l.get(mt);it===void 0&&(it=new WeakMap,l.set(mt,it));let ot=it.get(H);ot===void 0&&(ot=e.getUniformBlockIndex(mt,H.name),it.set(H,ot))}function Zt(H,mt){const ot=l.get(mt).get(H);c.get(mt)!==ot&&(e.uniformBlockBinding(mt,ot,H.__bindingPointIndex),c.set(mt,ot))}function de(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),o.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),h={},tt=null,et={},u={},f=new WeakMap,d=[],_=null,g=!1,m=null,p=null,M=null,x=null,v=null,T=null,b=null,E=new Qt(0,0,0),w=0,S=!1,y=null,R=null,I=null,L=null,D=null,$.set(0,0,e.canvas.width,e.canvas.height),N.set(0,0,e.canvas.width,e.canvas.height),a.reset(),o.reset(),r.reset()}return{buffers:{color:a,depth:o,stencil:r},enable:K,disable:Q,bindFramebuffer:lt,drawBuffers:ft,useProgram:bt,setBlending:z,setMaterial:fe,setFlipSided:zt,setCullFace:Ot,setLineWidth:Tt,setPolygonOffset:Jt,setScissorTest:Ct,activeTexture:P,bindTexture:A,unbindTexture:q,compressedTexImage2D:nt,compressedTexImage3D:rt,texImage2D:wt,texImage3D:Nt,updateUBOMapping:te,uniformBlockBinding:Zt,texStorage2D:ee,texStorage3D:ht,texSubImage2D:at,texSubImage3D:Pt,compressedTexSubImage2D:pt,compressedTexSubImage3D:yt,scissor:kt,viewport:At,reset:de}}function cl(e,t,n,i){const s=Bm(i);switch(n){case Gl:return e*t;case Xl:return e*t;case Yl:return e*t*2;case zr:return e*t/s.components*s.byteLength;case Br:return e*t/s.components*s.byteLength;case ql:return e*t*2/s.components*s.byteLength;case kr:return e*t*2/s.components*s.byteLength;case Wl:return e*t*3/s.components*s.byteLength;case pn:return e*t*4/s.components*s.byteLength;case Vr:return e*t*4/s.components*s.byteLength;case wa:case Aa:return Math.floor((e+3)/4)*Math.floor((t+3)/4)*8;case Ra:case Ca:return Math.floor((e+3)/4)*Math.floor((t+3)/4)*16;case nr:case sr:return Math.max(e,16)*Math.max(t,8)/4;case er:case ir:return Math.max(e,8)*Math.max(t,8)/2;case ar:case or:return Math.floor((e+3)/4)*Math.floor((t+3)/4)*8;case rr:return Math.floor((e+3)/4)*Math.floor((t+3)/4)*16;case cr:return Math.floor((e+3)/4)*Math.floor((t+3)/4)*16;case lr:return Math.floor((e+4)/5)*Math.floor((t+3)/4)*16;case hr:return Math.floor((e+4)/5)*Math.floor((t+4)/5)*16;case ur:return Math.floor((e+5)/6)*Math.floor((t+4)/5)*16;case fr:return Math.floor((e+5)/6)*Math.floor((t+5)/6)*16;case dr:return Math.floor((e+7)/8)*Math.floor((t+4)/5)*16;case pr:return Math.floor((e+7)/8)*Math.floor((t+5)/6)*16;case mr:return Math.floor((e+7)/8)*Math.floor((t+7)/8)*16;case _r:return Math.floor((e+9)/10)*Math.floor((t+4)/5)*16;case gr:return Math.floor((e+9)/10)*Math.floor((t+5)/6)*16;case Mr:return Math.floor((e+9)/10)*Math.floor((t+7)/8)*16;case xr:return Math.floor((e+9)/10)*Math.floor((t+9)/10)*16;case vr:return Math.floor((e+11)/12)*Math.floor((t+9)/10)*16;case yr:return Math.floor((e+11)/12)*Math.floor((t+11)/12)*16;case Pa:case Sr:case br:return Math.ceil(e/4)*Math.ceil(t/4)*16;case $l:case Er:return Math.ceil(e/4)*Math.ceil(t/4)*8;case Tr:case wr:return Math.ceil(e/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function Bm(e){switch(e){case Xn:case kl:return{byteLength:1,components:1};case Bs:case Vl:case Hs:return{byteLength:2,components:1};case Fr:case Or:return{byteLength:2,components:4};case Di:case Nr:case An:return{byteLength:4,components:1};case Hl:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${e}.`)}function km(e,t,n,i,s,a,o){const r=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new $t,h=new WeakMap;let u;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(P,A){return d?new OffscreenCanvas(P,A):Ua("canvas")}function g(P,A,q){let nt=1;const rt=Ct(P);if((rt.width>q||rt.height>q)&&(nt=q/Math.max(rt.width,rt.height)),nt<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const at=Math.floor(nt*rt.width),Pt=Math.floor(nt*rt.height);u===void 0&&(u=_(at,Pt));const pt=A?_(at,Pt):u;return pt.width=at,pt.height=Pt,pt.getContext("2d").drawImage(P,0,0,at,Pt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+rt.width+"x"+rt.height+") to ("+at+"x"+Pt+")."),pt}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+rt.width+"x"+rt.height+")."),P;return P}function m(P){return P.generateMipmaps}function p(P){e.generateMipmap(P)}function M(P){return P.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?e.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function x(P,A,q,nt,rt=!1){if(P!==null){if(e[P]!==void 0)return e[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let at=A;if(A===e.RED&&(q===e.FLOAT&&(at=e.R32F),q===e.HALF_FLOAT&&(at=e.R16F),q===e.UNSIGNED_BYTE&&(at=e.R8)),A===e.RED_INTEGER&&(q===e.UNSIGNED_BYTE&&(at=e.R8UI),q===e.UNSIGNED_SHORT&&(at=e.R16UI),q===e.UNSIGNED_INT&&(at=e.R32UI),q===e.BYTE&&(at=e.R8I),q===e.SHORT&&(at=e.R16I),q===e.INT&&(at=e.R32I)),A===e.RG&&(q===e.FLOAT&&(at=e.RG32F),q===e.HALF_FLOAT&&(at=e.RG16F),q===e.UNSIGNED_BYTE&&(at=e.RG8)),A===e.RG_INTEGER&&(q===e.UNSIGNED_BYTE&&(at=e.RG8UI),q===e.UNSIGNED_SHORT&&(at=e.RG16UI),q===e.UNSIGNED_INT&&(at=e.RG32UI),q===e.BYTE&&(at=e.RG8I),q===e.SHORT&&(at=e.RG16I),q===e.INT&&(at=e.RG32I)),A===e.RGB_INTEGER&&(q===e.UNSIGNED_BYTE&&(at=e.RGB8UI),q===e.UNSIGNED_SHORT&&(at=e.RGB16UI),q===e.UNSIGNED_INT&&(at=e.RGB32UI),q===e.BYTE&&(at=e.RGB8I),q===e.SHORT&&(at=e.RGB16I),q===e.INT&&(at=e.RGB32I)),A===e.RGBA_INTEGER&&(q===e.UNSIGNED_BYTE&&(at=e.RGBA8UI),q===e.UNSIGNED_SHORT&&(at=e.RGBA16UI),q===e.UNSIGNED_INT&&(at=e.RGBA32UI),q===e.BYTE&&(at=e.RGBA8I),q===e.SHORT&&(at=e.RGBA16I),q===e.INT&&(at=e.RGBA32I)),A===e.RGB&&q===e.UNSIGNED_INT_5_9_9_9_REV&&(at=e.RGB9_E5),A===e.RGBA){const Pt=rt?Ya:ne.getTransfer(nt);q===e.FLOAT&&(at=e.RGBA32F),q===e.HALF_FLOAT&&(at=e.RGBA16F),q===e.UNSIGNED_BYTE&&(at=Pt===he?e.SRGB8_ALPHA8:e.RGBA8),q===e.UNSIGNED_SHORT_4_4_4_4&&(at=e.RGBA4),q===e.UNSIGNED_SHORT_5_5_5_1&&(at=e.RGB5_A1)}return(at===e.R16F||at===e.R32F||at===e.RG16F||at===e.RG32F||at===e.RGBA16F||at===e.RGBA32F)&&t.get("EXT_color_buffer_float"),at}function v(P,A){let q;return P?A===null||A===Di||A===_s?q=e.DEPTH24_STENCIL8:A===An?q=e.DEPTH32F_STENCIL8:A===Bs&&(q=e.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===Di||A===_s?q=e.DEPTH_COMPONENT24:A===An?q=e.DEPTH_COMPONENT32F:A===Bs&&(q=e.DEPTH_COMPONENT16),q}function T(P,A){return m(P)===!0||P.isFramebufferTexture&&P.minFilter!==je&&P.minFilter!==wn?Math.log2(Math.max(A.width,A.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?A.mipmaps.length:1}function b(P){const A=P.target;A.removeEventListener("dispose",b),w(A),A.isVideoTexture&&h.delete(A)}function E(P){const A=P.target;A.removeEventListener("dispose",E),y(A)}function w(P){const A=i.get(P);if(A.__webglInit===void 0)return;const q=P.source,nt=f.get(q);if(nt){const rt=nt[A.__cacheKey];rt.usedTimes--,rt.usedTimes===0&&S(P),Object.keys(nt).length===0&&f.delete(q)}i.remove(P)}function S(P){const A=i.get(P);e.deleteTexture(A.__webglTexture);const q=P.source,nt=f.get(q);delete nt[A.__cacheKey],o.memory.textures--}function y(P){const A=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let nt=0;nt<6;nt++){if(Array.isArray(A.__webglFramebuffer[nt]))for(let rt=0;rt<A.__webglFramebuffer[nt].length;rt++)e.deleteFramebuffer(A.__webglFramebuffer[nt][rt]);else e.deleteFramebuffer(A.__webglFramebuffer[nt]);A.__webglDepthbuffer&&e.deleteRenderbuffer(A.__webglDepthbuffer[nt])}else{if(Array.isArray(A.__webglFramebuffer))for(let nt=0;nt<A.__webglFramebuffer.length;nt++)e.deleteFramebuffer(A.__webglFramebuffer[nt]);else e.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&e.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&e.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let nt=0;nt<A.__webglColorRenderbuffer.length;nt++)A.__webglColorRenderbuffer[nt]&&e.deleteRenderbuffer(A.__webglColorRenderbuffer[nt]);A.__webglDepthRenderbuffer&&e.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const q=P.textures;for(let nt=0,rt=q.length;nt<rt;nt++){const at=i.get(q[nt]);at.__webglTexture&&(e.deleteTexture(at.__webglTexture),o.memory.textures--),i.remove(q[nt])}i.remove(P)}let R=0;function I(){R=0}function L(){const P=R;return P>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+s.maxTextures),R+=1,P}function D(P){const A=[];return A.push(P.wrapS),A.push(P.wrapT),A.push(P.wrapR||0),A.push(P.magFilter),A.push(P.minFilter),A.push(P.anisotropy),A.push(P.internalFormat),A.push(P.format),A.push(P.type),A.push(P.generateMipmaps),A.push(P.premultiplyAlpha),A.push(P.flipY),A.push(P.unpackAlignment),A.push(P.colorSpace),A.join()}function F(P,A){const q=i.get(P);if(P.isVideoTexture&&Tt(P),P.isRenderTargetTexture===!1&&P.version>0&&q.__version!==P.version){const nt=P.image;if(nt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(nt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{N(q,P,A);return}}n.bindTexture(e.TEXTURE_2D,q.__webglTexture,e.TEXTURE0+A)}function O(P,A){const q=i.get(P);if(P.version>0&&q.__version!==P.version){N(q,P,A);return}n.bindTexture(e.TEXTURE_2D_ARRAY,q.__webglTexture,e.TEXTURE0+A)}function X(P,A){const q=i.get(P);if(P.version>0&&q.__version!==P.version){N(q,P,A);return}n.bindTexture(e.TEXTURE_3D,q.__webglTexture,e.TEXTURE0+A)}function V(P,A){const q=i.get(P);if(P.version>0&&q.__version!==P.version){k(q,P,A);return}n.bindTexture(e.TEXTURE_CUBE_MAP,q.__webglTexture,e.TEXTURE0+A)}const tt={[Qo]:e.REPEAT,[Ei]:e.CLAMP_TO_EDGE,[tr]:e.MIRRORED_REPEAT},et={[je]:e.NEAREST,[Tu]:e.NEAREST_MIPMAP_NEAREST,[Ks]:e.NEAREST_MIPMAP_LINEAR,[wn]:e.LINEAR,[to]:e.LINEAR_MIPMAP_NEAREST,[Ti]:e.LINEAR_MIPMAP_LINEAR},U={[Cu]:e.NEVER,[Nu]:e.ALWAYS,[Pu]:e.LESS,[jl]:e.LEQUAL,[Lu]:e.EQUAL,[Uu]:e.GEQUAL,[Du]:e.GREATER,[Iu]:e.NOTEQUAL};function B(P,A){if(A.type===An&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===wn||A.magFilter===to||A.magFilter===Ks||A.magFilter===Ti||A.minFilter===wn||A.minFilter===to||A.minFilter===Ks||A.minFilter===Ti)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(P,e.TEXTURE_WRAP_S,tt[A.wrapS]),e.texParameteri(P,e.TEXTURE_WRAP_T,tt[A.wrapT]),(P===e.TEXTURE_3D||P===e.TEXTURE_2D_ARRAY)&&e.texParameteri(P,e.TEXTURE_WRAP_R,tt[A.wrapR]),e.texParameteri(P,e.TEXTURE_MAG_FILTER,et[A.magFilter]),e.texParameteri(P,e.TEXTURE_MIN_FILTER,et[A.minFilter]),A.compareFunction&&(e.texParameteri(P,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(P,e.TEXTURE_COMPARE_FUNC,U[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===je||A.minFilter!==Ks&&A.minFilter!==Ti||A.type===An&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||i.get(A).__currentAnisotropy){const q=t.get("EXT_texture_filter_anisotropic");e.texParameterf(P,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,s.getMaxAnisotropy())),i.get(A).__currentAnisotropy=A.anisotropy}}}function $(P,A){let q=!1;P.__webglInit===void 0&&(P.__webglInit=!0,A.addEventListener("dispose",b));const nt=A.source;let rt=f.get(nt);rt===void 0&&(rt={},f.set(nt,rt));const at=D(A);if(at!==P.__cacheKey){rt[at]===void 0&&(rt[at]={texture:e.createTexture(),usedTimes:0},o.memory.textures++,q=!0),rt[at].usedTimes++;const Pt=rt[P.__cacheKey];Pt!==void 0&&(rt[P.__cacheKey].usedTimes--,Pt.usedTimes===0&&S(A)),P.__cacheKey=at,P.__webglTexture=rt[at].texture}return q}function N(P,A,q){let nt=e.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(nt=e.TEXTURE_2D_ARRAY),A.isData3DTexture&&(nt=e.TEXTURE_3D);const rt=$(P,A),at=A.source;n.bindTexture(nt,P.__webglTexture,e.TEXTURE0+q);const Pt=i.get(at);if(at.version!==Pt.__version||rt===!0){n.activeTexture(e.TEXTURE0+q);const pt=ne.getPrimaries(ne.workingColorSpace),yt=A.colorSpace===ri?null:ne.getPrimaries(A.colorSpace),ee=A.colorSpace===ri||pt===yt?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,A.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,A.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,ee);let ht=g(A.image,!1,s.maxTextureSize);ht=Jt(A,ht);const wt=a.convert(A.format,A.colorSpace),Nt=a.convert(A.type);let kt=x(A.internalFormat,wt,Nt,A.colorSpace,A.isVideoTexture);B(nt,A);let At;const te=A.mipmaps,Zt=A.isVideoTexture!==!0,de=Pt.__version===void 0||rt===!0,H=at.dataReady,mt=T(A,ht);if(A.isDepthTexture)kt=v(A.format===gs,A.type),de&&(Zt?n.texStorage2D(e.TEXTURE_2D,1,kt,ht.width,ht.height):n.texImage2D(e.TEXTURE_2D,0,kt,ht.width,ht.height,0,wt,Nt,null));else if(A.isDataTexture)if(te.length>0){Zt&&de&&n.texStorage2D(e.TEXTURE_2D,mt,kt,te[0].width,te[0].height);for(let it=0,ot=te.length;it<ot;it++)At=te[it],Zt?H&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,At.width,At.height,wt,Nt,At.data):n.texImage2D(e.TEXTURE_2D,it,kt,At.width,At.height,0,wt,Nt,At.data);A.generateMipmaps=!1}else Zt?(de&&n.texStorage2D(e.TEXTURE_2D,mt,kt,ht.width,ht.height),H&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ht.width,ht.height,wt,Nt,ht.data)):n.texImage2D(e.TEXTURE_2D,0,kt,ht.width,ht.height,0,wt,Nt,ht.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){Zt&&de&&n.texStorage3D(e.TEXTURE_2D_ARRAY,mt,kt,te[0].width,te[0].height,ht.depth);for(let it=0,ot=te.length;it<ot;it++)if(At=te[it],A.format!==pn)if(wt!==null)if(Zt){if(H)if(A.layerUpdates.size>0){const xt=cl(At.width,At.height,A.format,A.type);for(const _t of A.layerUpdates){const Xt=At.data.subarray(_t*xt/At.data.BYTES_PER_ELEMENT,(_t+1)*xt/At.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,_t,At.width,At.height,1,wt,Xt)}A.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,0,At.width,At.height,ht.depth,wt,At.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,it,kt,At.width,At.height,ht.depth,0,At.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Zt?H&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,0,At.width,At.height,ht.depth,wt,Nt,At.data):n.texImage3D(e.TEXTURE_2D_ARRAY,it,kt,At.width,At.height,ht.depth,0,wt,Nt,At.data)}else{Zt&&de&&n.texStorage2D(e.TEXTURE_2D,mt,kt,te[0].width,te[0].height);for(let it=0,ot=te.length;it<ot;it++)At=te[it],A.format!==pn?wt!==null?Zt?H&&n.compressedTexSubImage2D(e.TEXTURE_2D,it,0,0,At.width,At.height,wt,At.data):n.compressedTexImage2D(e.TEXTURE_2D,it,kt,At.width,At.height,0,At.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Zt?H&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,At.width,At.height,wt,Nt,At.data):n.texImage2D(e.TEXTURE_2D,it,kt,At.width,At.height,0,wt,Nt,At.data)}else if(A.isDataArrayTexture)if(Zt){if(de&&n.texStorage3D(e.TEXTURE_2D_ARRAY,mt,kt,ht.width,ht.height,ht.depth),H)if(A.layerUpdates.size>0){const it=cl(ht.width,ht.height,A.format,A.type);for(const ot of A.layerUpdates){const xt=ht.data.subarray(ot*it/ht.data.BYTES_PER_ELEMENT,(ot+1)*it/ht.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,ot,ht.width,ht.height,1,wt,Nt,xt)}A.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,ht.width,ht.height,ht.depth,wt,Nt,ht.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,kt,ht.width,ht.height,ht.depth,0,wt,Nt,ht.data);else if(A.isData3DTexture)Zt?(de&&n.texStorage3D(e.TEXTURE_3D,mt,kt,ht.width,ht.height,ht.depth),H&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,ht.width,ht.height,ht.depth,wt,Nt,ht.data)):n.texImage3D(e.TEXTURE_3D,0,kt,ht.width,ht.height,ht.depth,0,wt,Nt,ht.data);else if(A.isFramebufferTexture){if(de)if(Zt)n.texStorage2D(e.TEXTURE_2D,mt,kt,ht.width,ht.height);else{let it=ht.width,ot=ht.height;for(let xt=0;xt<mt;xt++)n.texImage2D(e.TEXTURE_2D,xt,kt,it,ot,0,wt,Nt,null),it>>=1,ot>>=1}}else if(te.length>0){if(Zt&&de){const it=Ct(te[0]);n.texStorage2D(e.TEXTURE_2D,mt,kt,it.width,it.height)}for(let it=0,ot=te.length;it<ot;it++)At=te[it],Zt?H&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,wt,Nt,At):n.texImage2D(e.TEXTURE_2D,it,kt,wt,Nt,At);A.generateMipmaps=!1}else if(Zt){if(de){const it=Ct(ht);n.texStorage2D(e.TEXTURE_2D,mt,kt,it.width,it.height)}H&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,wt,Nt,ht)}else n.texImage2D(e.TEXTURE_2D,0,kt,wt,Nt,ht);m(A)&&p(nt),Pt.__version=at.version,A.onUpdate&&A.onUpdate(A)}P.__version=A.version}function k(P,A,q){if(A.image.length!==6)return;const nt=$(P,A),rt=A.source;n.bindTexture(e.TEXTURE_CUBE_MAP,P.__webglTexture,e.TEXTURE0+q);const at=i.get(rt);if(rt.version!==at.__version||nt===!0){n.activeTexture(e.TEXTURE0+q);const Pt=ne.getPrimaries(ne.workingColorSpace),pt=A.colorSpace===ri?null:ne.getPrimaries(A.colorSpace),yt=A.colorSpace===ri||Pt===pt?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,A.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,A.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,yt);const ee=A.isCompressedTexture||A.image[0].isCompressedTexture,ht=A.image[0]&&A.image[0].isDataTexture,wt=[];for(let ot=0;ot<6;ot++)!ee&&!ht?wt[ot]=g(A.image[ot],!0,s.maxCubemapSize):wt[ot]=ht?A.image[ot].image:A.image[ot],wt[ot]=Jt(A,wt[ot]);const Nt=wt[0],kt=a.convert(A.format,A.colorSpace),At=a.convert(A.type),te=x(A.internalFormat,kt,At,A.colorSpace),Zt=A.isVideoTexture!==!0,de=at.__version===void 0||nt===!0,H=rt.dataReady;let mt=T(A,Nt);B(e.TEXTURE_CUBE_MAP,A);let it;if(ee){Zt&&de&&n.texStorage2D(e.TEXTURE_CUBE_MAP,mt,te,Nt.width,Nt.height);for(let ot=0;ot<6;ot++){it=wt[ot].mipmaps;for(let xt=0;xt<it.length;xt++){const _t=it[xt];A.format!==pn?kt!==null?Zt?H&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt,0,0,_t.width,_t.height,kt,_t.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt,te,_t.width,_t.height,0,_t.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Zt?H&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt,0,0,_t.width,_t.height,kt,At,_t.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt,te,_t.width,_t.height,0,kt,At,_t.data)}}}else{if(it=A.mipmaps,Zt&&de){it.length>0&&mt++;const ot=Ct(wt[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,mt,te,ot.width,ot.height)}for(let ot=0;ot<6;ot++)if(ht){Zt?H&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,0,0,wt[ot].width,wt[ot].height,kt,At,wt[ot].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,te,wt[ot].width,wt[ot].height,0,kt,At,wt[ot].data);for(let xt=0;xt<it.length;xt++){const Xt=it[xt].image[ot].image;Zt?H&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt+1,0,0,Xt.width,Xt.height,kt,At,Xt.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt+1,te,Xt.width,Xt.height,0,kt,At,Xt.data)}}else{Zt?H&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,0,0,kt,At,wt[ot]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,te,kt,At,wt[ot]);for(let xt=0;xt<it.length;xt++){const _t=it[xt];Zt?H&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt+1,0,0,kt,At,_t.image[ot]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+ot,xt+1,te,kt,At,_t.image[ot])}}}m(A)&&p(e.TEXTURE_CUBE_MAP),at.__version=rt.version,A.onUpdate&&A.onUpdate(A)}P.__version=A.version}function J(P,A,q,nt,rt,at){const Pt=a.convert(q.format,q.colorSpace),pt=a.convert(q.type),yt=x(q.internalFormat,Pt,pt,q.colorSpace),ee=i.get(A),ht=i.get(q);if(ht.__renderTarget=A,!ee.__hasExternalTextures){const wt=Math.max(1,A.width>>at),Nt=Math.max(1,A.height>>at);rt===e.TEXTURE_3D||rt===e.TEXTURE_2D_ARRAY?n.texImage3D(rt,at,yt,wt,Nt,A.depth,0,Pt,pt,null):n.texImage2D(rt,at,yt,wt,Nt,0,Pt,pt,null)}n.bindFramebuffer(e.FRAMEBUFFER,P),Ot(A)?r.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,nt,rt,ht.__webglTexture,0,zt(A)):(rt===e.TEXTURE_2D||rt>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&rt<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,nt,rt,ht.__webglTexture,at),n.bindFramebuffer(e.FRAMEBUFFER,null)}function K(P,A,q){if(e.bindRenderbuffer(e.RENDERBUFFER,P),A.depthBuffer){const nt=A.depthTexture,rt=nt&&nt.isDepthTexture?nt.type:null,at=v(A.stencilBuffer,rt),Pt=A.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,pt=zt(A);Ot(A)?r.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,pt,at,A.width,A.height):q?e.renderbufferStorageMultisample(e.RENDERBUFFER,pt,at,A.width,A.height):e.renderbufferStorage(e.RENDERBUFFER,at,A.width,A.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,Pt,e.RENDERBUFFER,P)}else{const nt=A.textures;for(let rt=0;rt<nt.length;rt++){const at=nt[rt],Pt=a.convert(at.format,at.colorSpace),pt=a.convert(at.type),yt=x(at.internalFormat,Pt,pt,at.colorSpace),ee=zt(A);q&&Ot(A)===!1?e.renderbufferStorageMultisample(e.RENDERBUFFER,ee,yt,A.width,A.height):Ot(A)?r.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ee,yt,A.width,A.height):e.renderbufferStorage(e.RENDERBUFFER,yt,A.width,A.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Q(P,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(e.FRAMEBUFFER,P),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const nt=i.get(A.depthTexture);nt.__renderTarget=A,(!nt.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),F(A.depthTexture,0);const rt=nt.__webglTexture,at=zt(A);if(A.depthTexture.format===hs)Ot(A)?r.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,rt,0,at):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,rt,0);else if(A.depthTexture.format===gs)Ot(A)?r.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,rt,0,at):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,rt,0);else throw new Error("Unknown depthTexture format")}function lt(P){const A=i.get(P),q=P.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==P.depthTexture){const nt=P.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),nt){const rt=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,nt.removeEventListener("dispose",rt)};nt.addEventListener("dispose",rt),A.__depthDisposeCallback=rt}A.__boundDepthTexture=nt}if(P.depthTexture&&!A.__autoAllocateDepthBuffer){if(q)throw new Error("target.depthTexture not supported in Cube render targets");Q(A.__webglFramebuffer,P)}else if(q){A.__webglDepthbuffer=[];for(let nt=0;nt<6;nt++)if(n.bindFramebuffer(e.FRAMEBUFFER,A.__webglFramebuffer[nt]),A.__webglDepthbuffer[nt]===void 0)A.__webglDepthbuffer[nt]=e.createRenderbuffer(),K(A.__webglDepthbuffer[nt],P,!1);else{const rt=P.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,at=A.__webglDepthbuffer[nt];e.bindRenderbuffer(e.RENDERBUFFER,at),e.framebufferRenderbuffer(e.FRAMEBUFFER,rt,e.RENDERBUFFER,at)}}else if(n.bindFramebuffer(e.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=e.createRenderbuffer(),K(A.__webglDepthbuffer,P,!1);else{const nt=P.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,rt=A.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,rt),e.framebufferRenderbuffer(e.FRAMEBUFFER,nt,e.RENDERBUFFER,rt)}n.bindFramebuffer(e.FRAMEBUFFER,null)}function ft(P,A,q){const nt=i.get(P);A!==void 0&&J(nt.__webglFramebuffer,P,P.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),q!==void 0&&lt(P)}function bt(P){const A=P.texture,q=i.get(P),nt=i.get(A);P.addEventListener("dispose",E);const rt=P.textures,at=P.isWebGLCubeRenderTarget===!0,Pt=rt.length>1;if(Pt||(nt.__webglTexture===void 0&&(nt.__webglTexture=e.createTexture()),nt.__version=A.version,o.memory.textures++),at){q.__webglFramebuffer=[];for(let pt=0;pt<6;pt++)if(A.mipmaps&&A.mipmaps.length>0){q.__webglFramebuffer[pt]=[];for(let yt=0;yt<A.mipmaps.length;yt++)q.__webglFramebuffer[pt][yt]=e.createFramebuffer()}else q.__webglFramebuffer[pt]=e.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){q.__webglFramebuffer=[];for(let pt=0;pt<A.mipmaps.length;pt++)q.__webglFramebuffer[pt]=e.createFramebuffer()}else q.__webglFramebuffer=e.createFramebuffer();if(Pt)for(let pt=0,yt=rt.length;pt<yt;pt++){const ee=i.get(rt[pt]);ee.__webglTexture===void 0&&(ee.__webglTexture=e.createTexture(),o.memory.textures++)}if(P.samples>0&&Ot(P)===!1){q.__webglMultisampledFramebuffer=e.createFramebuffer(),q.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,q.__webglMultisampledFramebuffer);for(let pt=0;pt<rt.length;pt++){const yt=rt[pt];q.__webglColorRenderbuffer[pt]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,q.__webglColorRenderbuffer[pt]);const ee=a.convert(yt.format,yt.colorSpace),ht=a.convert(yt.type),wt=x(yt.internalFormat,ee,ht,yt.colorSpace,P.isXRRenderTarget===!0),Nt=zt(P);e.renderbufferStorageMultisample(e.RENDERBUFFER,Nt,wt,P.width,P.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+pt,e.RENDERBUFFER,q.__webglColorRenderbuffer[pt])}e.bindRenderbuffer(e.RENDERBUFFER,null),P.depthBuffer&&(q.__webglDepthRenderbuffer=e.createRenderbuffer(),K(q.__webglDepthRenderbuffer,P,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(at){n.bindTexture(e.TEXTURE_CUBE_MAP,nt.__webglTexture),B(e.TEXTURE_CUBE_MAP,A);for(let pt=0;pt<6;pt++)if(A.mipmaps&&A.mipmaps.length>0)for(let yt=0;yt<A.mipmaps.length;yt++)J(q.__webglFramebuffer[pt][yt],P,A,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+pt,yt);else J(q.__webglFramebuffer[pt],P,A,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+pt,0);m(A)&&p(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Pt){for(let pt=0,yt=rt.length;pt<yt;pt++){const ee=rt[pt],ht=i.get(ee);n.bindTexture(e.TEXTURE_2D,ht.__webglTexture),B(e.TEXTURE_2D,ee),J(q.__webglFramebuffer,P,ee,e.COLOR_ATTACHMENT0+pt,e.TEXTURE_2D,0),m(ee)&&p(e.TEXTURE_2D)}n.unbindTexture()}else{let pt=e.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(pt=P.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(pt,nt.__webglTexture),B(pt,A),A.mipmaps&&A.mipmaps.length>0)for(let yt=0;yt<A.mipmaps.length;yt++)J(q.__webglFramebuffer[yt],P,A,e.COLOR_ATTACHMENT0,pt,yt);else J(q.__webglFramebuffer,P,A,e.COLOR_ATTACHMENT0,pt,0);m(A)&&p(pt),n.unbindTexture()}P.depthBuffer&&lt(P)}function St(P){const A=P.textures;for(let q=0,nt=A.length;q<nt;q++){const rt=A[q];if(m(rt)){const at=M(P),Pt=i.get(rt).__webglTexture;n.bindTexture(at,Pt),p(at),n.unbindTexture()}}}const Kt=[],z=[];function fe(P){if(P.samples>0){if(Ot(P)===!1){const A=P.textures,q=P.width,nt=P.height;let rt=e.COLOR_BUFFER_BIT;const at=P.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,Pt=i.get(P),pt=A.length>1;if(pt)for(let yt=0;yt<A.length;yt++)n.bindFramebuffer(e.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,Pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Pt.__webglFramebuffer);for(let yt=0;yt<A.length;yt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(rt|=e.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(rt|=e.STENCIL_BUFFER_BIT)),pt){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,Pt.__webglColorRenderbuffer[yt]);const ee=i.get(A[yt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,ee,0)}e.blitFramebuffer(0,0,q,nt,0,0,q,nt,rt,e.NEAREST),c===!0&&(Kt.length=0,z.length=0,Kt.push(e.COLOR_ATTACHMENT0+yt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Kt.push(at),z.push(at),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,z)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,Kt))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),pt)for(let yt=0;yt<A.length;yt++){n.bindFramebuffer(e.FRAMEBUFFER,Pt.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.RENDERBUFFER,Pt.__webglColorRenderbuffer[yt]);const ee=i.get(A[yt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,Pt.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+yt,e.TEXTURE_2D,ee,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Pt.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&c){const A=P.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[A])}}}function zt(P){return Math.min(s.maxSamples,P.samples)}function Ot(P){const A=i.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Tt(P){const A=o.render.frame;h.get(P)!==A&&(h.set(P,A),P.update())}function Jt(P,A){const q=P.colorSpace,nt=P.format,rt=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||q!==ys&&q!==ri&&(ne.getTransfer(q)===he?(nt!==pn||rt!==Xn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",q)),A}function Ct(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(l.width=P.naturalWidth||P.width,l.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(l.width=P.displayWidth,l.height=P.displayHeight):(l.width=P.width,l.height=P.height),l}this.allocateTextureUnit=L,this.resetTextureUnits=I,this.setTexture2D=F,this.setTexture2DArray=O,this.setTexture3D=X,this.setTextureCube=V,this.rebindTextures=ft,this.setupRenderTarget=bt,this.updateRenderTargetMipmap=St,this.updateMultisampleRenderTarget=fe,this.setupDepthRenderbuffer=lt,this.setupFrameBufferTexture=J,this.useMultisampledRTT=Ot}function Vm(e,t){function n(i,s=ri){let a;const o=ne.getTransfer(s);if(i===Xn)return e.UNSIGNED_BYTE;if(i===Fr)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Or)return e.UNSIGNED_SHORT_5_5_5_1;if(i===Hl)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===kl)return e.BYTE;if(i===Vl)return e.SHORT;if(i===Bs)return e.UNSIGNED_SHORT;if(i===Nr)return e.INT;if(i===Di)return e.UNSIGNED_INT;if(i===An)return e.FLOAT;if(i===Hs)return e.HALF_FLOAT;if(i===Gl)return e.ALPHA;if(i===Wl)return e.RGB;if(i===pn)return e.RGBA;if(i===Xl)return e.LUMINANCE;if(i===Yl)return e.LUMINANCE_ALPHA;if(i===hs)return e.DEPTH_COMPONENT;if(i===gs)return e.DEPTH_STENCIL;if(i===zr)return e.RED;if(i===Br)return e.RED_INTEGER;if(i===ql)return e.RG;if(i===kr)return e.RG_INTEGER;if(i===Vr)return e.RGBA_INTEGER;if(i===wa||i===Aa||i===Ra||i===Ca)if(o===he)if(a=t.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(i===wa)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Aa)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ra)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ca)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=t.get("WEBGL_compressed_texture_s3tc"),a!==null){if(i===wa)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Aa)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ra)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ca)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===er||i===nr||i===ir||i===sr)if(a=t.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(i===er)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===nr)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ir)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===sr)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ar||i===or||i===rr)if(a=t.get("WEBGL_compressed_texture_etc"),a!==null){if(i===ar||i===or)return o===he?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(i===rr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===cr||i===lr||i===hr||i===ur||i===fr||i===dr||i===pr||i===mr||i===_r||i===gr||i===Mr||i===xr||i===vr||i===yr)if(a=t.get("WEBGL_compressed_texture_astc"),a!==null){if(i===cr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===lr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===hr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ur)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===dr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===pr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===mr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===_r)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===gr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Mr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===xr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===vr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===yr)return o===he?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Pa||i===Sr||i===br)if(a=t.get("EXT_texture_compression_bptc"),a!==null){if(i===Pa)return o===he?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Sr)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===br)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===$l||i===Er||i===Tr||i===wr)if(a=t.get("EXT_texture_compression_rgtc"),a!==null){if(i===Pa)return a.COMPRESSED_RED_RGTC1_EXT;if(i===Er)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Tr)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===wr)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===_s?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}class Hm extends nn{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class rs extends Te{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Gm={type:"move"};class Co{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new rs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new rs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Y,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Y),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new rs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Y,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Y),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const n=this._hand;if(n)for(const i of t.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,n,i){let s=null,a=null,o=null;const r=this._targetRay,c=this._grip,l=this._hand;if(t&&n.session.visibilityState!=="visible-blurred"){if(l&&t.hand){o=!0;for(const g of t.hand.values()){const m=n.getJointPose(g,i),p=this._getHandJoint(l,g);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],f=h.position.distanceTo(u.position),d=.02,_=.005;l.inputState.pinching&&f>d+_?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&f<=d-_&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(a=n.getPose(t.gripSpace,i),a!==null&&(c.matrix.fromArray(a.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,a.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(a.linearVelocity)):c.hasLinearVelocity=!1,a.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(a.angularVelocity)):c.hasAngularVelocity=!1));r!==null&&(s=n.getPose(t.targetRaySpace,i),s===null&&a!==null&&(s=a),s!==null&&(r.matrix.fromArray(s.transform.matrix),r.matrix.decompose(r.position,r.rotation,r.scale),r.matrixWorldNeedsUpdate=!0,s.linearVelocity?(r.hasLinearVelocity=!0,r.linearVelocity.copy(s.linearVelocity)):r.hasLinearVelocity=!1,s.angularVelocity?(r.hasAngularVelocity=!0,r.angularVelocity.copy(s.angularVelocity)):r.hasAngularVelocity=!1,this.dispatchEvent(Gm)))}return r!==null&&(r.visible=s!==null),c!==null&&(c.visible=a!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(t,n){if(t.joints[n.jointName]===void 0){const i=new rs;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[n.jointName]=i,t.add(i)}return t.joints[n.jointName]}}const Wm=`
void main() {
...
`;function A_(){return new Yn({vertexShader:T_,fragmentShader:w_,uniforms:{uTime:{value:0},uWaveHeight:{value:3.6},uSunDir:{value:new Y(.6,.8,.4)},uSkyColor:{value:new Y(.5,.7,1)}},transparent:!0,depthWrite:!0,side:Tn})}const Oa=[];function R_(){const e=A_();return Oa.push(e),e}function C_(e){const t=Oa.indexOf(e);t!==-1&&Oa.splice(t,1),e.dispose()}function P_(e,t){for(const n of Oa)n.uniforms.uTime.value=e,t&&n.uniforms.uSunDir.value.copy(t)}const za=[];function L_(){const e=new Xs({vertexColors:!0,roughness:.85,metalness:0});return e.userData.uTime={value:0},e.onBeforeCompile=t=>{t.uniforms.uTime=e.userData.uTime,t.vertexShader=t.vertexShader.replace("#include <common>",`
      #include <common>
      uniform float uTime;
  ...
  `,e.appendChild(i);const s=document.createElement("div");s.className="lod-badge",s.id="lod-badge",s.textContent="LOD: HIGH",document.body.appendChild(s);const a=i.querySelector("#sel-category"),o=i.querySelector("#sel-type"),r=i.querySelector("#slider-wind"),c=i.querySelector("#wind-label"),l=i.querySelector("#btn-generate");function h(){const d=Ul[n.category];o.innerHTML=d.map(_=>{const g=_.charAt(0).toUpperCase()+_.slice(1);return`<option value="${_}">${g}</option>`}).join(""),n.type=d[0]}function u(d="generate"){t({...n,reason:d})}function f(d){const _=Math.min(Bo.length-1,Math.floor(d*Bo.length));c.textContent=Bo[_]}return a.addEventListener("change",()=>{n.category=a.value,h(),u()}),o.addEventListener("change",()=>{n.type=o.value,u()}),r.addEventListener("input",()=>{n.windIntensity=parseFloat(r.value),f(n.windIntensity),u("wind")}),l.addEventListener("click",()=>{u()}),h(),f(n.windIntensity),{getState:()=>({...n}),setLODLabel:d=>{s.textContent=`LOD: ${d}`},show(){i.style.display=""},hide(){i.style.display="none"}}}const Cx="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent",Px=/\b(fall|autumn|autumnal|harvest)\b/i;function Lx(e=0){return e%2===0?"aspen_yellow":"aspen_red"}const Dx=`You are a world-class voxel diorama designer. You compose stunning, atmospheric scenes using available voxel elements. Your scenes should feel like miniature worlds — rich with life, detail, and mood.

AVAILABLE ELEMENTS:
- Trees: birch, aspen, aspen_yellow, aspen_red, poplar, apple, orange, willow, pine, joshua, banana, coconut, sakura, cypress, stump_oak, stump_birch, stump_mossy
- Plants: monstera, ivy, rosebush, dracaena, yucca, cactus, prickly_pear, jade, bamboo, bonsai
- Flowers: rose, sunflower, tulip, lavender, daisy, orchid, chrysanthemum, lotus
- Wildgrass: tallgrass, prairie, pampas, reed, fescue, wheat, bamboo_grass
- Boulders: sandstone, granite, volcanic, limestone, slate, mossy, riverrock, coral, zen_stone
- Terrain: woodland, desert, beach, mountain, swampland, moon, martian, valley, tundra, volcanic_terrain, zen_garden
- Cliffs: woodland, desert, beach, mountain, swampland, moon, martian, valley, tundra, volcanic_terrain, zen_garden
- Props: torii_gate, stone_lantern, shrine, zen_bridge, bamboo_fence, pagoda, pot_terracotta, pot_wabisabi, pot_modern
- Architecture: brutalist_wall, brutalist_wall_door, brutalist_wall_window, brutalist_wall_slots, brutalist_floor, brutalist_roof, brutalist_stairs, brutalist_column, brutalist_beam, brutalist_planter, brutalist_bench, brutalist_railing, brutalist_canopy, brutalist_pilotis, brutalist_screen, brutalist_balcony

CORE RULES:
- ALWAYS start with exactly ONE Terrain at position (0,0).
- The terrain is ~336 voxel units wide. Spread elements across x/z range -140 to 140.
- Use 25-45 elements for normal scenes, 40-55 for dense/forest scenes.
- Group elements in natural, organic clusters — NEVER in grids or rows.
- Vary heights and types for visual interest. Mix large trees with small plants, grasses, and boulders.
- Every scene should have ground cover: ~30% wildgrass, ~10% boulders, scattered among trees and features.

══════════════════════════════════════════
BIOME RECIPES — Follow these for each terrain type:
══════════════════════════════════════════

WOODLAND: Temperate forest. Trees: birch, aspen, poplar, apple, pine. Stumps: stump_oak, stump_birch, stump_mossy (2-4 scattered). Wildgrass: tallgrass, prairie, fescue (fill all open ground). Flowers: daisy, rose, lavender. Boulders: mossy, riverrock, limestone. Cliff: woodland if needed. Add rosebush and dracaena as undergrowth.

DESERT: Arid, sparse. Trees: joshua. Plants: yucca, cactus, prickly_pear, jade. Wildgrass: prairie (sparse). Boulders: sandstone (dominant). Cliff: desert if needed. Flowers: none or very few. Keep elements sparse with wide spacing.

BEACH: Tropical coast. Trees: coconut, banana. Wildgrass: pampas. Boulders: coral, sandstone. Cliff: beach if needed. Flowers: orchid (sparingly). Plants: monstera, bamboo, yucca. CRITICAL: ocean is at z > 20. ALL vegetation MUST be at z < 20. Only boulders and cliffs may go past z=20.

MOUNTAIN: Alpine. Trees: pine (dominant), birch, aspen, poplar (lower slopes). Stumps: stump_oak (1-2). Wildgrass: fescue, tallgrass. Boulders: granite (dominant), slate. Cliff: mountain if needed. Flowers: daisy, lavender (alpine meadow clusters).

SWAMPLAND: Dark, boggy wetland. Trees: cypress, willow. Stumps: stump_mossy, stump_oak (3-5, swamps have many fallen/rotted trees). Wildgrass: reed (dominant, scatter everywhere). Boulders: mossy. Cliff: swampland if needed. Plants: monstera (tropical undergrowth). Flowers: lotus (in water areas). No cactus, no joshua.

VALLEY: Rolling meadow with stream. Trees: birch, aspen, poplar, apple, pine. Stumps: stump_oak, stump_birch (1-3). Wildgrass: tallgrass, prairie, fescue (fill meadows). Flowers: sunflower, daisy, lavender, tulip (wildflower patches). Boulders: riverrock, mossy. Cliff: valley if needed.

TUNDRA: Frozen, sparse. Trees: pine (stunted, few). Wildgrass: wheat, fescue (sparse). Boulders: granite, slate (exposed rock). Cliff: tundra if needed. No tropical plants. Keep sparse and bleak.

MOON / MARTIAN: Alien, barren. Trees: NONE or 1-2 joshua. Boulders: volcanic, granite, slate. Matching cliffs: moon for moon terrain, martian for martian terrain. Wildgrass: NONE. Flowers: NONE. Keep extremely minimal — mostly rock.

VOLCANIC_TERRAIN: Lava and obsidian. Trees: joshua (sparse). Boulders: volcanic (dominant). Cliff: volcanic_terrain if needed. Wildgrass: prairie (rare). Dark, dramatic.

ZEN_GARDEN: Japanese aesthetic. Trees: sakura (2-3), bonsai. Wildgrass: bamboo_grass (on grass zones only). Flowers: chrysanthemum, lotus. Boulders: zen_stone. Cliff: zen_garden if needed. Props: torii_gate, stone_lantern, shrine, zen_bridge, bamboo_fence. Place trees/flowers ONLY on grass zones (±55 to ±140 from center). Props and zen_stones on white gravel. Keep serene, asymmetric, spacious.

══════════════════════════════════════════
SCENE TYPE MODIFIERS:
══════════════════════════════════════════

DENSE / FOREST / JUNGLE / LUSH: Use 40-55 elements. Pack trees at 30-60 unit spacing. Fill EVERY gap with wildgrass (tallgrass, fescue, bamboo_grass). Add undergrowth plants between trees. Add 3-5 stumps for realism. 50%+ of elements should be wildgrass/ground cover.

SERENE / PEACEFUL / CALM: Normal element count. More flowers, fewer boulders. Add 1-2 lotus or lavender clusters. Wide spacing, lots of negative space.

SPOOKY / HAUNTED / DARK: Use swampland or woodland terrain. Heavy on stumps (stump_mossy, stump_oak). Add willow and cypress. Dense reed. Mossy boulders. Few flowers. Add a matching woodland or swampland cliff for atmosphere.

TROPICAL / PARADISE / ISLAND: Use beach terrain. Coconut and banana trees. Monstera and bamboo. Pampas grass. Coral boulders. Orchid flowers. All at z < 20.

ALPINE / HIGHLAND: Use mountain terrain. Pine-dominated. Granite boulders. Fescue grass. Daisy/lavender wildflower meadows. Birch at lower zones.

JAPANESE / ZEN: Use zen_garden terrain. Follow zen garden rules exactly.

FALL / AUTUMN / HARVEST: If you place aspens, use ONLY aspen_yellow and aspen_red. Do NOT use the green aspen type in fall scenes. Mix yellow and red aspens for seasonal variation.

══════════════════════════════════════════
SPECIAL PLACEMENT RULES:
══════════════════════════════════════════

- TREE STUMPS: stump_oak (wide, dark bark), stump_birch (white bark), stump_mossy (green, decaying). Place 2-5 in forest/swamp scenes. They add realism and ground-level detail. Scatter them between full trees.
- WILLOW: Use ONLY in swampland scenes, spooky/haunted scenes, or when the user explicitly asks for willow. Do not place willow in normal forest, woodland, valley, or alpine scenes by default.
- ASPEN IN FALL SCENES: When the prompt implies fall, autumn, or harvest, use ONLY aspen_yellow and aspen_red. Never use plain aspen in those scenes.
- POTTED PLANTS: ONLY in architectural/garden scenes (zen_garden, buildings). Never in wild nature scenes.
- IVY: ONLY against walls (cliffs, architecture). Never floating in the open.
- CLIFFS: 0-1 per scene. Match the cliff type to the terrain biome. Place at scene edges as a backdrop. Never in primary water zones.
- WATER AVOIDANCE — CRITICAL: Beach ocean is at z > 20. Place ALL vegetation at z < 20. Swampland has scattered pools — reeds fine anywhere, trees on high ground.

ARCHITECTURE SYSTEM:
When the user requests a building, house, structure, or anything architectural, use Architecture elements to construct it.

BRUTALIST BUILDING BLOCKS — raw concrete modular pieces:
- brutalist_wall: solid concrete wall (40 wide × 30 tall × 3 deep). Use as exterior/interior walls.
- brutalist_wall_door: same wall with a centered door opening. Use for entrances.
- brutalist_wall_window: wall with centered window cutout. Use for rooms needing light.
- brutalist_wall_slots: wall with narrow vertical slit windows. Signature brutalist look.
- brutalist_floor: flat concrete slab (40×40×2). Use as ground floors, upper floors, or platforms.
- brutalist_roof: flat slab with parapet edge (42×42). Place on top of walls.
- brutalist_stairs: concrete staircase rising 30 units (one story). Connects floors.
- brutalist_column: structural column (4×4×30). Supports beams and upper floors.
- brutalist_beam: horizontal concrete beam (40 long × 3 wide × 4 tall). Spans between columns.
- brutalist_planter: built-in concrete planter with greenery (20×10×8). Place near entries/patios.
- brutalist_bench: monolithic concrete bench (18 wide). Place in plazas/patios.
- brutalist_railing: concrete parapet (40 long × 8 tall). Edges of roofs, balconies, ramps.
- brutalist_canopy: floating concrete overhang (40×20). Shelters entries.
- brutalist_pilotis: elevated platform on columns (40×40, 24 high). Le Corbusier-style raised floor.
- brutalist_screen: perforated concrete brise-soleil (40×30). Decorative/privacy screen.
- brutalist_balcony: projecting balcony with railing (20×10). Attach to wall faces.

ASSEMBLY RULES:
- All elements support "y" (vertical offset) and "rotation" (0, 90, 180, 270 degrees).
- Standard story height is 30 voxels. Stack floors at y=0, y=30, y=60, etc.
- Walls are 40 wide. Place adjacent walls at x or z offsets of 40 to form continuous walls.
- To make an L-shaped or U-shaped building, rotate walls 90° and align them at corners.
- Place brutalist_floor at y=0 for ground floor. For a second story, place another at y=30.
- Place brutalist_roof at the top (e.g., y=30 for single story, y=60 for two stories).
- Use brutalist_column at corners and midpoints under floors to support upper levels.
- Place brutalist_stairs against a wall, rising from one floor to the next.
- Always face door walls toward the main viewing direction or entry path.
- Use brutalist_planter and brutalist_bench to furnish outdoor spaces.
- Pair buildings with appropriate terrain, landscaping trees, and ground cover.
- For a simple brutalist house: 4 walls (front=door, back=wall, sides=windows), 1 floor, 1 roof.
- For a pavilion: pilotis base + floor slab + screen walls + canopy.
- For a multi-story: stack wall layers at y=0 and y=30, floors between, stairs connecting, roof on top.

OUTPUT FORMAT:
Return ONLY a valid JSON array. No markdown, no explanation, no wrapping.
Each element:
{ "category": "Trees", "type": "willow", "x": 0, "z": 0, "seed": 42381 }
Architecture elements also support y and rotation:
{ "category": "Architecture", "type": "brutalist_wall", "x": -20, "z": -20, "y": 0, "rotation": 0, "seed": 12345 }

- category: one of "Trees", "Plants", "Flowers", "Wildgrass", "Boulders", "Terrain", "Cliffs", "Props", "Architecture"
- type: must match one of the available types listed above exactly
- x, z: world position in voxel units. Terrain at (0,0). Other elements spread across -140 to 140. Space generously.
- y: vertical offset (default 0). Use for stacking Architecture elements (floors at y=0, 30, 60...).
- rotation: degrees (0, 90, 180, 270). Rotates element around Y axis. Default 0.
- seed: random integer 1-99999 for variation

Example nature scene:
[{"category":"Terrain","type":"woodland","x":0,"z":0,"seed":8821},{"category":"Trees","type":"birch","x":-100,"z":-60,"seed":33210},{"category":"Trees","type":"aspen","x":60,"z":80,"seed":12451},{"category":"Trees","type":"stump_mossy","x":-30,"z":40,"seed":5511},{"category":"Wildgrass","type":"tallgrass","x":-80,"z":20,"seed":7742},{"category":"Wildgrass","type":"fescue","x":30,"z":-40,"seed":9921},{"category":"Boulders","type":"mossy","x":100,"z":-100,"seed":4432}]

Example brutalist house:
[{"category":"Terrain","type":"valley","x":0,"z":0,"seed":1122},{"category":"Architecture","type":"brutalist_floor","x":0,"z":0,"y":0,"rotation":0,"seed":2001},{"category":"Architecture","type":"brutalist_wall_door","x":0,"z":-20,"y":0,"rotation":0,"seed":2002},{"category":"Architecture","type":"brutalist_wall_window","x":0,"z":20,"y":0,"rotation":180,"seed":2003},{"category":"Architecture","type":"brutalist_wall_window","x":-20,"z":0,"y":0,"rotation":90,"seed":2004},{"category":"Architecture","type":"brutalist_wall_slots","x":20,"z":0,"y":0,"rotation":270,"seed":2005},{"category":"Architecture","type":"brutalist_roof","x":0,"z":0,"y":30,"rotation":0,"seed":2006},{"category":"Architecture","type":"brutalist_planter","x":10,"z":-25,"y":0,"rotation":0,"seed":2007},{"category":"Trees","type":"birch","x":-80,"z":60,"seed":3001}]`;function Ix(){try{const e=(localStorage.getItem("gemini_key")||"").trim();if(e)return e}catch{}try{const e=(window.prompt(`Paste your Google Gemini API key to use the Creator.
Stored locally in your browser only — never uploaded.
Get one free at https://aistudio.google.com/apikey`)||"").trim();if(e){try{localStorage.setItem("gemini_key",e)}catch{}return e}}catch{}return null}async function Ux(e){var g,m,p;const t=Ix();if(!t)throw new Error("No Gemini key set. Get one free at aistudio.google.com/apikey — stored locally as gemini_key.");const n=await fetch(`${Cx}?key=${encodeURIComponent(t)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({system_instruction:{parts:[{text:Dx}]},contents:[{role:"user",parts:[{text:e}]}],generationConfig:{temperature:.8,maxOutputTokens:4096,responseMimeType:"application/json"}})});if(!n.ok){const M=await n.text();throw new Error(`Gemini API error ${n.status}: ${M}`)}const s=(((p=(m=(g=(await n.json()).candidates)==null?void 0:g[0])==null?void 0:m.content)==null?void 0:p.parts)||[]).map(M=>M.text||"").join("").trim();if(!s)throw new Error("Empty response from LLM");let a=s;a.startsWith("```")&&(a=a.replace(/^```(?:json)?\s*/,"").replace(/\s*```$/,""));let o;try{o=JSON.parse(a)}catch{try{const x="["+a.replace(/\}\s*\n\s*\{/g,"},{")+"]";o=JSON.parse(x)}catch{throw new Error(`Failed to parse LLM response as JSON: ${a.slice(0,200)}`)}}if(!Array.isArray(o))throw new Error("LLM response is not an array");const r=["Trees","Plants","Flowers","Wildgrass","Boulders","Terrain","Cliffs","Props","Architecture"],c=o.filter(M=>r.includes(M.category)&&typeof M.type=="string"&&typeof M.x=="number"&&typeof M.z=="number"),l=Px.test(e),h=c.find(M=>M.category==="Terrain"),u=(h==null?void 0:h.type)||"",d={swampland:["cactus","prickly_pear","joshua"],tundra:["cactus","prickly_pear","joshua","coconut","banana"],moon:["cactus","prickly_pear","joshua","coconut","banana"],martian:["cactus","prickly_pear","joshua","coconut","banana"],beach:["cactus","prickly_pear"],woodland:["cactus","prickly_pear","joshua"],valley:["cactus","prickly_pear","joshua"]}[u]||[];let _=c.filter(M=>!d.includes(M.type));if(l&&(_=_.map(M=>M.category==="Trees"&&M.type==="aspen"?{...M,type:Lx(M.seed||0)}:M)),u==="beach"){const M=["Boulders","Terrain","Cliffs"];_=_.filter(x=>M.includes(x.category)||x.z<20)}return _}function Nx(e,t,n){const i=document.createElement("div");i.className="creator-panel",i.innerHTML=`
  ...
  `,e.appendChild(i);const s=i.querySelector("#creator-prompt"),a=i.querySelector("#btn-create"),o=i.querySelector("#btn-back"),r=i.querySelector("#creator-status"),c=i.querySelector("#creator-elements");let l=!1;async function h(){if(l)return;const u=s.value.trim();if(u){l=!0,a.disabled=!0,a.textContent="Thinking...",r.textContent="",r.className="creator-status",c.innerHTML="";try{r.textContent="Asking Kimi to design your scene...";const f=await Ux(u);if(!f.length){r.textContent="No valid elements returned. Try rephrasing.",r.className="creator-status error";return}r.textContent=`Composing ${f.length} elements...`,c.innerHTML=f.map((d,_)=>`<div class="creator-el">${d.category} &rsaquo; <strong>${d.type}</strong> <span class="creator-el-pos">(${d.x}, ${d.z})</span></div>`).join(""),t(f),r.textContent=`Scene ready — ${f.length} elements placed`,r.className="creator-status success"}catch(f){r.textContent=f.message,r.className="creator-status error",console.error("Scene generation error:",f)}finally{l=!1,a.disabled=!1,a.textContent="Generate Scene"}}}return a.addEventListener("click",h),s.addEventListener("keydown",u=>{u.key==="Enter"&&(u.metaKey||u.ctrlKey)&&h()}),o.addEventListener("click",n),{show(){i.style.display=""},hide(){i.style.display="none"},el:i}}const Fx={Trees:yh,Plants:Sh,Flowers:bh,Wildgrass:wh,Boulders:Rh,Terrain:Lh,Cliffs:Uh,Props:Nh,Architecture:zh};function Ja(e,t,n,i){switch(i%4){case 0:return[e,t,n];case 1:return[-n,t,e];case 2:return[-e,t,-n];case 3:return[n,t,-e];default:return[e,t,n]}}function Ox(e,t){let n=1/0;const i=new Map;for(const[s]of e){const[a,o,r]=s.split(",").map(Number);if(o<n&&(n=o,i.clear()),o===n){const[c,,l]=Ja(a,o,r,t);i.set(`${c},${l}`,{x:c,z:l})}}return{minY:Number.isFinite(n)?n:0,contacts:[...i.values()]}}function zx(e,t){let n=1/0,i=-1/0,s=1/0,a=-1/0;for(const[o]of e){const[r,c,l]=o.split(",").map(Number),[h,,u]=Ja(r,c,l,t);n=Math.min(n,h),i=Math.max(i,h),s=Math.min(s,u),a=Math.max(a,u)}return{minX:Number.isFinite(n)?n:0,maxX:Number.isFinite(i)?i:0,minZ:Number.isFinite(s)?s:0,maxZ:Number.isFinite(a)?a:0}}function Bx(e,t,n,i,s,a,o){let r=1;for(const[c,l]of n){const[h,u,f]=c.split(",").map(Number),[d,_,g]=Ja(h,u,f,o),m=d+i,p=_+s,M=g+a,x=l.scale||1,v=p+x,T=`${m},${M}`;r=Math.max(r,x),l.type===3?(!t.has(T)||v>t.get(T))&&t.set(T,v):(!e.has(T)||v>e.get(T))&&e.set(T,v)}return r}function ks(e,t,n,i,s=2){if(e.size===0)return 0;const a=Math.round(t/i)*i,o=Math.round(n/i)*i;let r=e.get(`${a},${o}`);if(r!=null)return r;for(let c=1;c<=s;c++){for(let l=-c;l<=c;l++)for(let h=-c;h<=c;h++){const u=e.get(`${a+l*i},${o+h*i}`);u!=null&&(r==null||u>r)&&(r=u)}if(r!=null)return r}return 0}function kx(e){const t=e.maxX-e.minX,i=e.maxZ-e.minZ>=t?"z":"x",s=i==="z"?e.minZ:e.minX,a=i==="z"?e.maxZ:e.maxX,o=i==="z"?e.minX:e.minZ,r=i==="z"?e.maxX:e.maxZ,c=Math.max(1,a-s),l=Math.max(1,r-o),h=Math.max(6,Math.round(c/20)),u=Math.max(4,Math.round(l/6)),f=[];for(let d=s;d<=a;d+=h){const _=c>0?(d-s)/c*2-1:0;for(let g=o;g<=r;g+=u)f.push(i==="z"?{x:g,z:d,t:_}:{x:d,z:g,t:_})}return f.push(i==="z"?{x:0,z:s,t:-1}:{x:s,z:0,t:-1}),f.push(i==="z"?{x:0,z:a,t:1}:{x:a,z:0,t:1}),{samples:f}}function Nl(e,t,n,i,s,a){let o=0,r=0,c=0,l=0,h=0,u=0;for(const d of i.samples){const _=s+d.x,g=a+d.z,m=ks(t,_,g,n,1),p=ks(e,_,g,n,2),M=Math.abs(d.t)>.78,x=Math.abs(d.t)<.45;m>0&&(r++,h+=d.t,u++,x&&o++,M&&c++),M&&p>0&&l++}if(o===0||r===0)return-1/0;const f=u>0?Math.abs(h/u)*12:0;return o*8+r*2+l*4-c*6-f}function Vx(e,t,n,i,s,a){let o={x:s,z:a,score:Nl(e,t,n,i,s,a)};const r=Math.max(3,n),c=n*14;for(let l=-c;l<=c;l+=r)for(let h=-c;h<=c;h+=r){const u=s+l,f=a+h,d=Nl(e,t,n,i,u,f);d>o.score&&(o={x:u,z:f,score:d})}return o}function Hx(e,t,n,i,s,a,o,r){let c=0,l=0;for(const f of i.samples){if(Math.abs(f.t)<.82)continue;const d=s+f.x,_=a+f.z;c=Math.max(c,ks(e,d,_,n,2)),l=Math.max(l,ks(t,d,_,n,1))}const h=Math.max(2,n);return Math.max(c,l+h)-o+r}function Gx(e){const t=new Map,n=new Set,i=new Map,s=new Map;let a=1;const o=[],r=[];for(const l of e)l.category==="Terrain"?o.push(l):r.push(l);const c=[...o,...r];for(let l=0;l<c.length;l++){const h=c[l],u=Fx[h.category];if(!u)continue;let f=h.seed||Math.floor(Math.random()*1e5);for(f=f*31+l*7919,f=(f%99999+99999)%99999+1;n.has(f);)f++;n.add(f);let d;try{d=u(h.type,f)}catch(T){console.warn(`SceneComposer: failed to generate ${h.category}/${h.type}`,T);continue}const _=Math.round(h.x||0),g=Math.round(h.z||0),m=Math.round((h.rotation||0)/90)%4,p=Math.round(h.y||0);let M=_,x=p,v=g;if(h.category==="Terrain")a=Math.max(a,Bx(i,s,d,_,x,g,m));else if(i.size>0){const{minY:T,contacts:b}=Ox(d,m);if(h.category==="Props"&&h.type==="zen_bridge"&&s.size>0){const E=kx(zx(d,m)),w=Vx(i,s,a,E,_,g);M=w.x,v=w.z,x=Hx(i,s,a,E,M,v,T,p)}else{let E=0;for(const w of b)E=Math.max(E,ks(i,_+w.x,g+w.z,a));x=E-T+p}}for(const[T,b]of d){const[E,w,S]=T.split(",").map(Number),[y,R,I]=Ja(E,w,S,m),L=`${y+M},${R+x},${I+v}`;t.set(L,b)}}return t}const Wx=document.getElementById("viewport"),Le=new E_(Wx);let Vs=[],fn=Math.floor(Math.random()*1e5);const Jr=document.createElement("div");Jr.style.cssText="position:fixed;top:10px;right:10px;background:rgba(0,0,0,0.7);color:#0f0;font:bold 14px monospace;padding:8px 12px;border-radius:6px;z-index:9999;pointer-events:none;line-height:1.6;";document.body.appendChild(Jr);let qs=0,ko=0,Vo=performance.now(),Ta=0;function Xx(){ko++;const e=performance.now();e-Vo>=500&&(Ta=Math.round(ko/((e-Vo)/1e3)),ko=0,Vo=e);const t=Ta>=55?"#0f0":Ta>=30?"#ff0":"#f44";Jr.innerHTML=`<span style="color:${t}">${Ta} FPS</span><br>${qs.toLocaleString()} voxels`}function Bh(){for(const e of Vs)Le.scene.remove(e),e.traverse(t=>{t.geometry&&t.geometry.dispose(),t.material&&(t.material.isShaderMaterial?(C_(t.material),I_(t.material)):Array.isArray(t.material)?t.material.forEach(n=>n.dispose()):t.material.dispose()),t.instanceMatrix&&(t.instanceMatrix=null),t.instanceColor&&(t.instanceColor=null)});Vs=[],qs=0}function Qr({category:e,type:t}){Bh();let n;e==="Trees"?n=yh(t,fn):e==="Plants"?n=Sh(t,fn):e==="Wildgrass"?n=wh(t,fn):e==="Boulders"?n=Rh(t,fn):e==="Terrain"?n=Lh(t,fn):e==="Cliffs"?n=Uh(t,fn):e==="Props"?n=Nh(t,fn):e==="Architecture"?n=zh(t,fn):n=bh(t,fn),qs=n.size;const{lod:i,maxHeight:s}=e==="Terrain"?V_(n):e==="Boulders"||e==="Cliffs"?Pr(n,{highGapFactor:1,mediumGapFactor:1,lowGapFactor:1}):Pr(n);Le.scene.add(i),Vs.push(i);const a=s*.45;Le.controls.target.set(0,a,0),Le.camera.position.set(6,4,6),Le.controls.update()}function Yx(e){Bh();const t=Gx(e);qs=t.size;const{lod:n,maxHeight:i}=Pr(t);Le.scene.add(n),Vs.push(n);const s=i*.35;Le.controls.target.set(0,s,0),Le.camera.position.set(12,8,12),Le.controls.maxDistance=160,Le.controls.update()}const $s=document.createElement("div");$s.className="view-switcher";$s.innerHTML=`
  <button class="view-tab active" data-view="elements">Elements</button>
  <button class="view-tab" data-view="creator">Creator</button>
`;document.body.appendChild($s);const qx=$s.querySelectorAll(".view-tab");function kh(e){qx.forEach(t=>t.classList.toggle("active",t.dataset.view===e)),Le.setKeyboardNavigationEnabled(e==="creator"),e==="elements"?(zs.show(),Ir.hide(),Le.controls.maxDistance=80,fn=Math.floor(Math.random()*1e5),Qr(zs.getState())):(zs.hide(),Ir.show(),Le.controls.maxDistance=160)}$s.addEventListener("click",e=>{const t=e.target.closest(".view-tab");t&&kh(t.dataset.view)});const $x=document.getElementById("ui-root"),zs=Rx($x,e=>{e.reason!=="wind"&&(fn=Math.floor(Math.random()*1e5),Qr(e))}),tc=document.createElement("div");tc.style.cssText="position:fixed;bottom:24px;left:24px;z-index:10;";document.body.appendChild(tc);const Ir=Nx(tc,e=>Yx(e),()=>kh("elements"));Ir.hide();const ec=document.createElement("div");ec.className="light-control";ec.innerHTML=`
...
`;document.body.appendChild(ec);const Vh=document.getElementById("light-azimuth"),Hh=document.getElementById("light-elevation");function Gh(){const e=parseFloat(Vh.value)*Math.PI/180,t=parseFloat(Hh.value)/90;Le.setSunDirection(e,t)}Vh.addEventListener("input",Gh);Hh.addEventListener("input",Gh);Qr(zs.getState());const Zx=new r_;function Wh(){requestAnimationFrame(Wh);const e=Zx.getElapsedTime(),t=Le.sun.position;P_(e,t.clone().normalize()),U_(e,t.clone().normalize());const n=Le.getCameraDistance();let i=0;for(const s of Vs)s.isLOD&&(s.update(Le.camera),i+=G_(s,n));qs=i,Xx(),zs.setLODLabel(H_(n)),Le.render()}Wh();
